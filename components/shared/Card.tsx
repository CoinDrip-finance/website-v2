...
const MagicCard = ({
  ...
  size = 600,
  spotlight = true,
  spotlightColor = "rgba(0, 255, 250, 0.11)",
  borderColor = "rgba(0, 255, 250, 0.25)",
  isolated = true,
  ...props
}: MagicCardProps) => {
  return (
    ...
    >
      ...
      <div
        className={cn(
          "pointer-events-none absolute inset-0 h-full w-full rounded-2xl  transition-opacity duration-500 bg-[#027B72]",
